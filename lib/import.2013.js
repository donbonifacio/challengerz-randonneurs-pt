...
Challengerz.init(process.env.CHALLENGERZ_KEY, 'production');
...
Challengerz.queue(function createEvent(next) {
  Challengerz.createEvent(_.extend(baseEvent, {
    ...
    slug: 'langique-200',
    distance: 200,
    date: new Date(2013, 1, 2, 8).getTime(),
    website: 'http://www.randonneursportugal.pt/lantique-200/',
    region: 'Lisboa',
...
Challengerz.queue(function createEvent(next) {
  Challengerz.createEvent(_.extend(baseEvent, {
    ...
    distance: 300,
    date: new Date(2013, 2, 2, 6).getTime(),
    website: 'http://www.randonneursportugal.pt/brm/planicies-e-montados300/',
    region: 'Lisboa',
    city: 'Vila Franca de Xira',
    loc: [38.958341, -8.988559]
  }), advance('Event', next));
...
Challengerz.queue(function createEvent(next) {
  Challengerz.createEvent(_.extend(baseEvent, {
    ...
    slug: 'alto-minho',
    distance: 200,
    date: new Date(2013, 3, 13, 7, 15).getTime(),
    website: 'http://www.randonneursportugal.pt/alto-minho-200/',
    region: 'Braga',
    city: 'Marinhas',
...
Challengerz.queue(function createEvent(next) {
  Challengerz.createEvent(_.extend(baseEvent, {
    ...
    distance: 300,
    date: new Date(2013, 4, 4, 5, 30).getTime(),
    website: 'http://www.randonneursportugal.pt/baixo-minho-e-barroso-300/',
...
Challengerz.queue(function createEvent(next) {
  Challengerz.createEvent(_.extend(baseEvent, {
    ...
    slug: 'alqueva-400',
    distance: 400,
    date: new Date(2013, 4, 25, 0, 0).getTime(),
    region: 'Lisboa',
    city: 'Vila Franca de Xira',
    website: 'http://www.randonneursportugal.pt/brm/alqueva400/',
    loc: [38.958341, -8.988559]
  }), advance('Event', next));
});
...
Challengerz.queue(function createEvent(next) {
  Challengerz.createEvent(_.extend(baseEvent, {
    ...
    date: new Date(2013, 4, 25, 0, 0).getTime(),
    region: 'Lisboa',
    website: 'http://www.randonneursportugal.pt/midnight-ride-200/',
    city: 'Vila Franca de Xira',
    loc: [38.958341, -8.988559]
  }), advance('Event', next));
});
...
Challengerz.queue(function createEvent(next) {
  Challengerz.createEvent(_.extend(baseEvent, {
    ...
    date: new Date(2013, 5, 22, 14, 0).getTime(),
...
Challengerz.queue(function createEvent(next) {
  Challengerz.createEvent(_.extend(baseEvent, {
    ...
    distance: 200,
    date: new Date(2013, 9, 18, 8, 0).getTime(),
...
Challengerz.queue(function createEvent(next) {
  Challengerz.createEvent(_.extend(baseEvent, {
    ...
    distance: 1000,
    edition: 2014,
    date: new Date(2014, 9, 18, 8, 0).getTime(),
